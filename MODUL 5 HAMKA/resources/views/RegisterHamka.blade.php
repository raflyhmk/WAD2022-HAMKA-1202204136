                ...
                <form method="POST" action="">
                  @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="exampleInputTelpon" name="no_hp" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" class="form-control" id="exampleInputKonfirmasi" name="password_confirmation" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Login</button>
                    <h3 class="forRegister fw-light mt-3">Anda sudah punya akun? <a href="/LoginHamka">Login</a></h3>
                </form>
            </div>
        </div>
    </div>
